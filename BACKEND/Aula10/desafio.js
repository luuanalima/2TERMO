// Desafio1: em vez de buscar um produto especifico, usem o comando .filter() para mostrar na tela uma lista de todos os produtos que tenham menos de 100 unidades no estoque
const fs = require('fs');
